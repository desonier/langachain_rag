...
class ResumeQuerySystem:
    ...
    def _create_rag_chain(self):
        ...
        try:
            ...
            template = """You are a helpful assistant that answers questions based on the provided resume context.
    ...
    def query(self, question, resume_id=None):
        ...
        try:
            if resume_id:
                ...
                source_documents = filtered_retriever.invoke(question)
    ...
    def search_by_metadata(self, query, metadata_filter=None):
        ...
        try:
            if metadata_filter:
                ...
                result = filtered_qa_chain.invoke(query)
                source_documents = filtered_retriever.invoke(query)
                return {"result": result, "source_documents": source_documents}
            else:
